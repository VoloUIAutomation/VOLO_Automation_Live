...
class ItemListPage(GeneralHelpers):
    categories = (
        By.XPATH, "//div[contains(@class,'desktopRefinements')]//\
            div[contains(@class,'categoryrefinement')]/h3/span")
    categories_by_type = (
        By.XPATH, f"//li[@class='expandable']/a[text()='{testdata.category}']")
    personalized = (By.XPATH, "//span[text()='Personalized']")
    price_high_to_low = (
        By.XPATH, "//div[@class='selectric-scroll']//\
            li[text()='Price High to Low']")
    first_item = (
        By.XPATH, "//a[@class='name-link']//\
            h2[text()='Snowy Fox Open Collar Cardigan']")
